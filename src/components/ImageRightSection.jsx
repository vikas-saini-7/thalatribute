...
const ImageRightSection = ({ title, paragraph, imageSrc }) => {
  return (
    <div className="container flex flex-col md:flex-row justify-center items-center mx-auto text-white info-section">
